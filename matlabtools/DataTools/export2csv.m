...
%cfg.excludenames     : Cell array with characters, indicating datatypes to exclude from exporting, mostly handy when not utilizing datanames.
...
%Check all datanames against data from p1, if the datanames is incompatible
