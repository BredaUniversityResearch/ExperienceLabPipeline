...
%% GET IN OUT FROM BEACONS
%function out = getinoutfrombeacons(cfg)
%
% *DESCRIPTION*
%This function takes a specific beacon file (as generated by the
%experiencelab beacon app) and compares it to the beaconmeta to determine
%when people entered and exited the indicated area.
%
% *INPUT*
%Configuration Options
%   cfg.inbeacons = 3; %The ID of the beacons triggering the In moment
%   cfg.outbeacons = 12; %The ID of the beacons triggering the Out moment
...
%   cfg.beacondata = []; %If beacondata is not from file, then you can define your own beacondata. Requires the same structure as given by beacon2matlab
