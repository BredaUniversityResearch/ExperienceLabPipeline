function project = belt_open_GPS_project(cfg, project)
%% BELT_OPEN_PROJECT
%  function segment = belt_open_GPS_project(cfg, project)
% 
% *DESCRIPTION*
...
if isfield(project, 'project_directory') && isfield(project, 'project_name')
    ...
    path_filename = fullfile(project.project_directory, ['project_' project.project_name '_GPS.belt']);
else
