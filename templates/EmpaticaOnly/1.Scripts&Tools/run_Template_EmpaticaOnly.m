...
for i=1:length(data_deconvolved)
    ...
    if (addParticipant == true)
        ...
        data_edited = data_deconvolved(i);
...
cfg = [];
cfg.savename = 'Template_EmpaticaOnly.csv';
cfg.datanames = {'participant' 'initial_time_stamp' 'initial_time_stamp_mat' 'fsample' 'time'  'conductance' 'conductance_z' 'phasic' 'phasic_z' 'tonic' 'tonic_z' 'bvp' 'heartrate' 'temperature' 'setting' 'average'};
